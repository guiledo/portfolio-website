...
export const projects: Project[] = [
  {
    ...
    description: {
      'en-US': 'A modern, high-performance URL shortener built with TypeScript, React, and Java / Spring Boot. Developed to showcase fullstack engineering skills, including API design, database modeling, and cloud deployment.',
      'pt-BR': 'Um encurtador de URL moderno e de alta performance construído com TypeScript, React e Java / Spring Boot. Desenvolvido para demonstrar habilidades de engenharia fullstack, incluindo design de API, modelagem de banco de dados e implantação em nuvem.',
    },
    tech: ['Java', 'Spring Boot', 'React', 'TypeScript', 'PostgreSQL', 'Tailwind CSS', 'Supabase', 'Render', 'Vercel'],
