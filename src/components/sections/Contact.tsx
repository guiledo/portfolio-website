...
const Contact = () => {
  ...
  return (
    <section id="contact" className="flex items-center py-12">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
                  <h2 className="text-4xl md:text-5xl font-bold mb-4">
                    {t('contact.title')}
                  </h2>
                  <p className="text-xl text-muted-foreground mb-12 text-lg">
                    ...
                    {contacts.map((contact) => (
                      ...
                      >
                        <a href={contact.href} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-3 text-center">
                          ...
                          <div>
                            <p className="text-lg font-semibold mb-1">{contact.label}</p>
